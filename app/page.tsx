...
export default function Home() {
  ...
  const words = `Revolutionize your content creation with our AI-powered app,delivering engaging and high-quality apps in seconds.`;
  const headertext = [
    {
      text: "Build",
    },
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              ...
              <TypewriterEffect words={headertext} />
            </h1>
          </div>

          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className=" font-bold text-lg text-gray-600 dark:text-neutral-400">
              {words}
            </p>
          </div>
